...
public class Lib {
	...
	public static final String DBPROPS_PATH = "db.props";
	
	public static String DB_URL = "jdbc:mysql://localhost:3307/";
	public static String DB_SCHEMA = "ce832_rspere";
	public static String DB_USER = "root";
	public static String DB_PASSWD = "mysql";
	...
	public static Connection getConnection(String dbUrl, String dbSchema,
		...
		try
		{
			result = DriverManager.getConnection(dbUrl + dbSchema, dbUser, dbPassword);
		} 
		
		catch (SQLException e) 
		{
			System.out.println("Trying to connect to database with user = " + dbUser+ " and empty password");
	...
	public static Connection getConnectionFromProperties() throws SQLException {
		Properties p = new Properties();
		try {
			p.load(new FileInputStream(DBPROPS_PATH));
		    }
		catch (IOException e)
		{
		}
		...
		return getConnection(p.getProperty("URL"), p.getProperty("SCHEMA"),
